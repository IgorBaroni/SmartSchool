        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, "Marta", "Kent", "492853256"),
                    new Aluno(2, "Paula", "Isabela", "847572845"),
                    new Aluno(3, "Laura", "Antonia", "322345849"),
                    new Aluno(4, "Luiza", "Maria", "482759202"),
                    new Aluno(5, "Lucas", "Machado", "194720475"),
                    new Aluno(6, "Pedro", "Alvares", "385627456"),
                    new Aluno(7, "Paulo", "José", "274859376")
                });
